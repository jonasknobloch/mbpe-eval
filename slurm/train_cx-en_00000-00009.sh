...
#SBATCH --job-name=morph-gpt_gpt2_cx-en_00000-00009
...
python run_clm.py \
    --model_type gpt2 \
    --tokenizer_file ./tokenizers/tokenizer_gpt2_cx-en_00000-00000.json \
    ...
    --report_to wandb \
    --output_dir ./out/${NOW:-0000_000000}/gpt2_cx-en_00000-00009
