...
#SBATCH --job-name=morph-gpt_gpt2+morf_cx-en_00000-00009_50k
...
python run_clm.py \
    --model_type gpt2 \
    --tokenizer_file ./tokenizers/tokenizer_gpt2+morf_cx-en_00000-00000_50k.json \
    ...
    --report_to wandb \
    --output_dir ./out/${NOW:-0000_000000}/gpt2+morf_cx-en_00000-00009_50k
