...
#SBATCH --job-name=morph-gpt_gpt2+ts_cx-cs_00000-00019_50k
...
python run_clm.py \
    --model_type gpt2 \
    --tokenizer_file ./tokenizers/tokenizer_gpt2+ts_cx-cs_00000-00001_50k.json \
    ...
    --report_to wandb \
    --output_dir ./out/${NOW:-0000_000000}/gpt2+ts_cx-cs_00000-00019_50k
